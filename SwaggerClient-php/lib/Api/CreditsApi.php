...
class CreditsApi
{
     ...
     * @return \Swagger\Client\Model\CreditsResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CreditsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function creditsWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\CreditsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CreditsResponse',
