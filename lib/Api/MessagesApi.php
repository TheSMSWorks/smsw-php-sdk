...
class MessagesApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Query $query query (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\MessagesResponse
     */
    public function getInboxMessages($query)
    {
        list($response) = $this->getInboxMessagesWithHttpInfo($query);
        return $response;
    }
     ...
     */
    public function getInboxMessagesWithHttpInfo($query)
    {
        $returnType = '\Swagger\Client\Model\MessagesResponse';
        $request = $this->getInboxMessagesRequest($query);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxMessagesAsync($query)
    {
        return $this->getInboxMessagesAsyncWithHttpInfo($query)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxMessagesAsyncWithHttpInfo($query)
    {
        $returnType = '\Swagger\Client\Model\MessagesResponse';
        $request = $this->getInboxMessagesRequest($query);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxMessagesRequest($query)
    {
        // verify the required parameter 'query' is set
        if ($query === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $query when calling getInboxMessages'
            );
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\MessagesResponse';
        $request = $this->getMessagesRequest($query);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesAsync($query)
    {
        return $this->getMessagesAsyncWithHttpInfo($query)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesAsyncWithHttpInfo($query)
    {
        $returnType = '\Swagger\Client\Model\MessagesResponse';
        $request = $this->getMessagesRequest($query);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMessagesRequest($query)
    {
        // verify the required parameter 'query' is set
        if ($query === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $query when calling getMessages'
            );
        }
    ...
    public function scheduleMessageWithHttpInfo($sms_message)
    {
        ...
        $request = $this->scheduleMessageRequest($sms_message);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function scheduleMessageAsync($sms_message)
    {
        return $this->scheduleMessageAsyncWithHttpInfo($sms_message)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function scheduleMessageAsyncWithHttpInfo($sms_message)
    {
        $returnType = '\Swagger\Client\Model\ScheduledMessageResponse';
        $request = $this->scheduleMessageRequest($sms_message);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function scheduleMessageRequest($sms_message)
    {
        // verify the required parameter 'sms_message' is set
        if ($sms_message === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sms_message when calling scheduleMessage'
            );
        }
    ...
    public function sendMessageWithHttpInfo($sms_message)
    {
        ...
        $request = $this->sendMessageRequest($sms_message);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMessageAsync($sms_message)
    {
        return $this->sendMessageAsyncWithHttpInfo($sms_message)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMessageAsyncWithHttpInfo($sms_message)
    {
        $returnType = '\Swagger\Client\Model\SendMessageResponse';
        $request = $this->sendMessageRequest($sms_message);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendMessageRequest($sms_message)
    {
        // verify the required parameter 'sms_message' is set
        if ($sms_message === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sms_message when calling sendMessage'
            );
        }
