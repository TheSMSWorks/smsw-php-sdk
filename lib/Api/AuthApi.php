...
class AuthApi
{
     ...
     * Operation keySecret
     *
     * @param  string $customerid Utility method. Please generate your API key by following the instructions on your account page at https://thesmsworks.co.uk/user/login (required)
     *
     ...
     * Operation login
     *
     * @param  \Swagger\Client\Model\Login $body API Key &amp; Secret (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
