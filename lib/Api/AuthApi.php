...
class AuthApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\ApiKeyResponse';
        $request = $this->keySecretRequest($customerid);
     ...
     */
    public function keySecretAsync($customerid)
    {
        return $this->keySecretAsyncWithHttpInfo($customerid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keySecretAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $customerid The Customer ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keySecretAsyncWithHttpInfo($customerid)
    {
        $returnType = '\Swagger\Client\Model\ApiKeyResponse';
        $request = $this->keySecretRequest($customerid);
    ...
    /**
     * Create request for operation 'keySecret'
     *
     * @param  string $customerid The Customer ID (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function keySecretRequest($customerid)
    {
        // verify the required parameter 'customerid' is set
        if ($customerid === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customerid when calling keySecret'
            );
        }
    ...
    public function loginWithHttpInfo($credentials)
    {
        ...
        $request = $this->loginRequest($credentials);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginAsync($credentials)
    {
        return $this->loginAsyncWithHttpInfo($credentials)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginAsyncWithHttpInfo($credentials)
    {
        $returnType = '\Swagger\Client\Model\TokenResponse';
        $request = $this->loginRequest($credentials);
    ...
    protected function loginRequest($credentials)
    {
        ...
        if ($credentials === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credentials when calling login'
            );
        }
