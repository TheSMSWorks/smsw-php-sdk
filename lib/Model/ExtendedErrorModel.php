 ...
 */
class ExtendedErrorModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendedErrorModel';
    ...
    */
     ...
     * Sets error_code
     *
     * @param float $error_code Numeric code used to identify the error. Integer.
     *
     * @return self
     */
