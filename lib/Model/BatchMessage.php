 ...
 */
class BatchMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchMessage';
    ...
    */
     ...
     * Sets ttl
     *
     * @param float|null $ttl The number of minutes before the delivery report is deleted. Optional. Omit to prevent delivery report deletion. Integer.
     *
     * @return self
     */
    ...
    public function setValidity($validity)
    {
        ...
        if (($validity > 2880)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling BatchMessage., must be smaller than or equal to 2880.');
        }
        if (($validity < 1)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling BatchMessage., must be bigger than or equal to 1.');
        }
